<nav class="sidebar fixed left-0 top-0 h-screen w-[280px] bg-linear-to-b from-gray-800 to-gray-900 text-white z-50 transition-all duration-300" id="sidebar">
    ...
    <ul class="list-none py-5 m-0">
        <li class="h-[48px] px-[25px] cursor-pointer border-l-4 border-transparent flex items-center gap-2 hover:bg-gray-700 transition-colors"><a href="http://localhost/IHM_admindashboard.php" class="text-white no-underline flex items-center gap-2 w-full font-bold">Dashboard</a></li>
        <li class="h-[48px] px-[25px] cursor-pointer border-l-4 border-transparent flex items-center gap-2 hover:bg-gray-700 transition-colors"><a href="http://localhost/IHM_admin/utilisateurs.php" class="text-white no-underline flex items-center gap-2 w-full font-bold">Utilisateurs</a></li>
